...
function processScript (scriptPart, vueJestConfig, filePath, babelTestObj) {
  if (!scriptPart) {
    return { code: '' }
  }
  ...
  return compileBabel(scriptPart.content, undefined, undefined, vueJestConfig, filePath, babelTestObj)
}

// fourth argument is istanbul, it's injecting automatically
module.exports = function (src, filePath, jestConfig, _, babelTestObj) {

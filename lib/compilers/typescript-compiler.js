...
module.exports = function compileTypescript (scriptContent, vueJestConfig, filePath, babelOverWrites) {
  ...
  return compileBabel(res.outputText, inputSourceMap, inlineBabelConfig, vueJestConfig, undefined, babelOverWrites)
}

...
module.exports = function compileBabel (scriptContent, inputSourceMap, inlineConfig, vueJestConfig, filePath, babelTestObj) {
  ...
  if (babelTestObj !== undefined) {
    babelOptions = Object.assign(babelOptions, babelTestObj)
  }

  // babel 7 throws error if filename is undefined, "unknown" is default
  if (!babelOptions.filename) babelOptions.filename = 'unknown'

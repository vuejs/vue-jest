...
module.exports = function compileBabel (scriptContent, inputSourceMap, inlineConfig, vueJestConfig, filePath, babelOverWrites) {
  ...
  // version is not a babel option, We are passing it from test to determine if user is using @babel/.... for .babelrc
  const babel7 = babelOptions.version === 7 ? require('@babel/core') : undefined
  let res
  if (babel7) {
    // delete the version property, as it may/will error-out in transforming
    delete babelOptions.version
